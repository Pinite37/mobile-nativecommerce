      ...
      <View className="flex-row justify-between items-center px-6 pt-16 pb-4">
        ...
        {!isLast && (
          <TouchableOpacity
            ...
            activeOpacity={1}
          >
            <Text className="text-neutral-500 font-jakarta-medium text-sm">
              Passer
            </Text>
          </TouchableOpacity>
        )}
      ...
      <Animated.View style={[animatedStyle]} className="flex-1">
        ...
        <View className="flex-1 justify-center items-center px-6">
          ...
          <View className="items-center mb-8">
            <Text className="text-2xl font-jakarta-bold text-neutral-900 text-center mb-4">
              {title}
            </Text>
            <Text className="text-base font-jakarta text-neutral-600 text-center leading-6">
              {subtitle}
            </Text>
          </View>
        </View>
        ...
        <View className="flex-row justify-center items-center">
          {!isFirst && (
            <TouchableOpacity
              ...
              activeOpacity={1}
            >
              <Text className="text-neutral-700 font-jakarta-semibold text-base">
                Précédent
              </Text>
            </TouchableOpacity>
          )}
