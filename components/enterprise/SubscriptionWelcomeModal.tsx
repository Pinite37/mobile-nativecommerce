      ...
      <View className="flex-1 bg-white">
        ...
        >
          <View className="items-center">
            ...
            <Text className="text-white/90 font-jakarta-medium text-center text-base">
        ...
        >
          <View className="bg-neutral-50 rounded-2xl p-5 border border-neutral-200">
            <Text className="text-neutral-800 font-jakarta-bold text-base mb-2">
              Vérification du compte
            </Text>
            <Text className="text-neutral-600 font-jakarta-medium text-sm leading-6">
          ...
          >
            {loading ? (
              ...
              <>
                ...
                <Text className="ml-2 text-white font-jakarta-bold text-base">
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <Text className="text-neutral-700 font-jakarta-bold text-base">
              Continuer
            </Text>
          </TouchableOpacity>
        </ScrollView>
    ...
    <View className="flex-1 bg-white">
        ...
        >
          {loadingPlans ? (
            ...
            <View className="bg-gradient-to-br from-primary-50 to-primary-100 rounded-3xl p-6 mb-6 border-2 border-primary-500">
              <View className="items-center py-8">
                ...
                <Text className="text-neutral-600 font-jakarta-medium mt-4">
            ...
            <View className="bg-gradient-to-br from-primary-50 to-primary-100 rounded-3xl p-6 mb-6 border-2 border-primary-500">
                ...
                <View className="flex-1">
                  <View className="flex-row items-center mb-2">
                    <View className="bg-primary-500 rounded-full px-3 py-1">
                      <Text className="text-white font-jakarta-bold text-xs">
                        RECOMMANDÉ
                      </Text>
                    </View>
                  </View>
                  <Text className="text-2xl font-jakarta-bold text-neutral-800 mb-1">
                    {trialPlan?.name || 'Essai Gratuit'}
                  </Text>
                  <Text className="text-lg font-jakarta-semibold text-primary-600">
                ...
                {(trialPlan?.features || []).map((feature, index) => (
                  <View key={index} className="flex-row items-start mb-2">
                    <Ionicons
                      ...
                      style={{ marginTop: 2 }}
                    />
                    <Text className="ml-2 text-neutral-700 font-jakarta-medium flex-1">
                      {feature}
                    </Text>
                  </View>
                ))}
              ...
              >
                {loading ? (
                  <View className="flex-col items-center">
                    ...
                    {activationProgress && (
                      <Text className="text-white/80 font-jakarta-medium text-xs">
                        {activationProgress}
                      </Text>
                    )}
                  </View>
              ...
              <Text className="text-neutral-500 font-jakarta-medium text-xs text-center mt-3">
              ...
              {loading && (
                <View className="bg-blue-50 border border-blue-200 rounded-xl p-3 mt-3">
                  <View className="flex-row items-center">
                    ...
                    <Text className="ml-2 text-blue-600 font-jakarta-medium text-xs flex-1">
          ...
          <View className="flex-row items-center my-6">
            ...
            <Text className="mx-4 text-neutral-500 font-jakarta-medium text-sm">
              OU
            </Text>
            <View className="flex-1 h-px bg-neutral-200" />
          </View>
          ...
          >
            ...
            <Text className="ml-2 text-primary-500 font-jakarta-bold text-base">
              Voir tous les plans
            </Text>
          </TouchableOpacity>

          <Text className="text-neutral-500 font-jakarta-medium text-xs text-center mt-4">
          ...
          <View className="bg-neutral-50 rounded-2xl p-4 mt-6">
            <View className="flex-row items-start">
              <Ionicons
                ...
                style={{ marginTop: 2 }}
              />
              <Text className="ml-3 text-neutral-600 font-jakarta-medium text-sm flex-1">
