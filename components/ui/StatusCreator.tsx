      ...
      {screen === 'image_editing' && rawPickedBase64 ? (
        ...
        <View style={{ flex: 1, backgroundColor: bgColor }}>
          <View style={{
            ...
            >
              {submitting
                ...
                : <Text style={{ color: '#fff', fontFamily: 'PlusJakartaSans-Bold', fontSize: 15 }}>Publier</Text>}
            </TouchableOpacity>
          </View>
          ...
          <View style={{ flex: 1, justifyContent: 'center', paddingHorizontal: 28 }}>
            <TextInput
              ...
              maxLength={500}
              style={{
                color: '#fff', fontFamily: 'PlusJakartaSans-Bold', fontSize: 26,
          ...
          <View style={{
            ...
            <TextInput
              ...
              style={{
                ...
                color: '#fff', fontFamily: 'PlusJakartaSans-Medium', fontSize: 15,
        ...
        <View style={{ flex: 1, backgroundColor: colors.background }}>
          ...
          <View style={{
            ...
            <Text style={{ color: colors.textPrimary, fontSize: 18, fontFamily: 'PlusJakartaSans-Bold', flex: 1 }}>
              Nouveau statut
            </Text>
          </View>
          ...
          {loadingGallery ? (
            ...
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 36 }}>
              ...
              <Text style={{
                color: colors.textSecondary, fontFamily: 'PlusJakartaSans-SemiBold',
              ...
              >
                <Text style={{ color: '#fff', fontFamily: 'PlusJakartaSans-Bold', fontSize: 15 }}>Autoriser</Text>
              </TouchableOpacity>
            </View>
          ) : (
            <FlatList
          ...
          <View style={{
            ...
            >
              <Text style={{ color: '#fff', fontFamily: 'PlusJakartaSans-Bold', fontSize: 17 }}>Aa</Text>
              <Text style={{ color: '#fff', fontFamily: 'PlusJakartaSans-SemiBold', fontSize: 15 }}>Statut texte</Text>
            </TouchableOpacity>
