            ...
            >
              <View className="p-6">
                ...
                <View className="items-center mb-4">
                  ...
                  <Text className="text-xl font-jakarta-bold text-neutral-800 text-center mb-2">
                    {title}
                  </Text>
                  <Text className="text-base text-neutral-600 font-jakarta-medium text-center leading-6">
                    {message}
                  </Text>
                </View>
                ...
                <View className="space-y-3">
                  ...
                  <TouchableOpacity
                    ...
                    activeOpacity={0.7}
                  >
                    <Text className="font-jakarta-semibold text-neutral-700">
                      {cancelText}
                    </Text>
                  </TouchableOpacity>
                </View>
