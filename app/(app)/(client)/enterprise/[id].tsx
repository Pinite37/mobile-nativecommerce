...
export default function EnterpriseDetails() {
      ...
      setErrorModal({
        ...
        message:
          result.reason === "invalid_phone"
            ...
            : i18n.t("client.enterprise.error.whatsappError"),
      });
    }
  };
    ...
    if (!result.ok) {
      setErrorModal({
        ...
        message:
          result.reason === "invalid_phone"
            ? "Numéro de téléphone non disponible"
            : i18n.t("client.enterprise.error.callError"),
      });
    }
  };
  ...
  const SkeletonProductCard = () => (
    ...
    >
      ...
      <View className="p-3">
        <ShimmerBlock
          style={{ height: 14, borderRadius: 7, width: "85%", marginBottom: 8 }}
        />
        <ShimmerBlock
  ...
  const SkeletonEnterpriseInfo = () => (
    <View
      className="mx-4 rounded-2xl shadow-sm mb-6"
      style={{
        backgroundColor: colors.card || colors.background,
        borderColor: colors.border,
        borderWidth: 1,
    ...
    >
      <View className="p-6">
        ...
        <ShimmerBlock
          style={{ height: 14, borderRadius: 7, width: "90%", marginBottom: 6 }}
        />
        <ShimmerBlock
          style={{
            height: 14,
        ...
        <View className="flex-row justify-between mb-4">
          ...
          >
            ...
            />
            <ShimmerBlock
              style={{ height: 12, borderRadius: 6, width: "45%" }}
            />
          </View>
        </View>
        <ShimmerBlock
  ...
  const renderSkeletonEnterprise = () => (
    <View className="flex-1" style={{ backgroundColor: colors.background }}>
      ...
      <LinearGradient
        ...
        className="pb-6 rounded-b-3xl shadow-md"
        ...
        ListHeaderComponent={
          <View>
            ...
            <View className="px-4 mb-4">
              <View className="flex-row items-center justify-between">
                <ShimmerBlock
                  style={{ height: 18, borderRadius: 9, width: "50%" }}
                />
                <ShimmerBlock
                  style={{ height: 16, borderRadius: 8, width: "20%" }}
                />
              </View>
            </View>
          </View>
            ...
            >
              ...
              <View className="p-6">
                ...
                <View className="flex-row justify-between mb-6">
                  ...
                  <View
                    className="flex-1 rounded-xl p-4 mx-1"
                    style={{
                      backgroundColor: isDark
                        ? colors.surface || "#1f2937"
                        : "#f9fafb",
                ...
                <View className="mt-2">
                  <Text
                    className="text-sm font-quicksand-semibold mb-4"
                    style={{ color: colors.text }}
                  >
                    ...
                    {enterprise.contactInfo.phone && (
                      <>
                        ...
                        <TouchableOpacity
                          ...
                          className="flex-row items-center bg-warning-100 rounded-xl px-3 py-2 mr-2 mb-2"
                          activeOpacity={0.8}
                        >
