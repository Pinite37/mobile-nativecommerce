            ...
            >
              <View className="flex-row items-center justify-between">
                <View className="flex-row items-center">
                  <Text className="text-lg font-jakarta-semibold text-neutral-800">
                    {address.title}
                  </Text>
                  {address.isDefault && (
              ...
              <Text className="text-neutral-800 font-jakarta-medium mb-1">
                {address.recipient}
              </Text>
              <Text className="text-neutral-600 font-jakarta mb-1">
                {address.address}
              </Text>
              <Text className="text-neutral-600 font-jakarta mb-1">
