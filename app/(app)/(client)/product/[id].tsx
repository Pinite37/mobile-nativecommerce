...
export default function ProductDetails() {
    ...
    >
      ...
      <View className="p-3">
        <Text
          ...
          className="text-sm font-jakarta-semibold mb-2 leading-5"
        >
          {similarProduct.name}
        </Text>
  ...
  const handleToggleFollow = async () => {
    if (!requireAuth("Connectez-vous pour vous abonner à cette entreprise.")) return;
    ...
    <View style={[styles.safe, { backgroundColor: colors.card }]}>
      ...
      */}
      ...
      <View style={styles.headerWrapper} pointerEvents="none">
        ...
        >
          <Text style={styles.bigTitle} className="font-jakarta-bold">
            {product.name}
          </Text>
          <Text style={styles.subTitle} className="font-jakarta-medium">
      ...
      >
        ...
        >
          ...
          <View className="mb-6">
            <Text className="text-3xl font-jakarta-bold text-primary-600 mb-2">
              {formatPrice(product.price)}
            </Text>
            <Text
              style={{ color: colors.textSecondary }}
              className="font-jakarta-medium leading-6"
            >
              {product.description}
            </Text>
          </View>
          ...
          >
            <Text
              style={{ color: colors.textPrimary }}
              className="text-lg font-jakarta-bold mb-3"
            >
            ...
            {enterprise &&
              (contactPhone || contactWebsite || contactWhatsapp) && (
                ...
                >
                  <Text
                    style={{ color: colors.textSecondary }}
                    className="text-sm font-jakarta-bold mb-3 uppercase tracking-wider"
                  >
                  ...
                  <View style={{ flexDirection: "row", gap: 10, marginBottom: contactWebsite ? 10 : 0 }}>
                    {contactWhatsapp && (
                      ...
                      >
                        ...
                        <Text style={{ color: "#fff", marginLeft: 8, fontSize: 14 }} className="font-jakarta-bold">
                          WhatsApp
                        </Text>
                      </TouchableOpacity>
                    )}
                    {contactPhone && (
                      ...
                      >
                        ...
                        <Text style={{ color: "#FE8C00", marginLeft: 8, fontSize: 14 }} className="font-jakarta-bold">
                  ...
                  {contactWebsite && (
                    ...
                    >
                      ...
                      <Text style={{ color: "#3B82F6", marginLeft: 8, fontSize: 14 }} className="font-jakarta-bold">
                        Site web
                      </Text>
                    </TouchableOpacity>
                  )}
            ...
            {enterprise?.description ? (
              ...
              >
                <Text
                  style={{ color: colors.textSecondary }}
                  className="text-sm font-jakarta-bold mb-2 uppercase tracking-wider"
                >
...
const styles = StyleSheet.create({
  ...
  compactTitle: {
    color: "#fff",
    fontSize: 18,
    // fontWeight: "700", // Removed in favor of font-jakarta-bold
    flex: 1,
    textAlign: "center",
    marginHorizontal: 10,
  },
  ...
  bigTitle: {
    color: "#fff",
    fontSize: 32,
    // fontWeight: "900", // Removed in favor of font-jakarta-bold
  ...
  subTitle: {
    color: "#eee",
    fontSize: 16,
    // fontWeight: '600', // Removed in favor of font-jakarta-medium
    opacity: 0.9,
