  ...
  const SimilarProductCard = ({
    ...
    >
      ...
      <View style={{ padding: 10 }}>
        ...
        <Text style={{ color: "#10B981", fontSize: 13 }} className="font-jakarta-bold">
          ...
          <View style={{ marginBottom: 24 }}>
            ...
            >
              ...
              <View style={{ marginLeft: 12, flex: 1 }}>
                <Text style={{ color: colors.textPrimary, fontSize: 15 }} className="font-jakarta-bold">
                  {typeof product.enterprise === "object"
                ...
                {typeof product.enterprise === "object" &&
                  product.enterprise.location && (
                    <View style={{ flexDirection: "row", alignItems: "center", marginTop: 3 }}>
                      ...
                      <Text style={{ color: colors.textSecondary, fontSize: 12, marginLeft: 3 }} className="font-jakarta-medium">
              ...
              product.enterprise.contactInfo?.phone && (
                <View style={{ flexDirection: "row", gap: 8, marginBottom: 8 }}>
                  ...
                  >
                    ...
                    <Text style={{ color: "#16A34A", marginLeft: 7, fontSize: 14 }} className="font-jakarta-bold">
                  ...
                  >
                    ...
                    <Text style={{ color: "#EA580C", marginLeft: 7, fontSize: 14 }} className="font-jakarta-bold">
            ...
            >
              ...
              <Text style={{ color: "#fff", marginLeft: 8, fontSize: 15 }} className="font-jakarta-bold">
