    ...
    try {
      ...
      if (response.success) {
        ...
        if (tokens.accessToken) {
          ...
          console.log(
            "🔓 Activation complète de la session après vérification OTP (flux inscription)...",
          );
          ...
          setTimeout(() => {
            if (effectiveRole) {
              console.log(
                "🚀 Redirection post-OTP vers home pour rôle:",
                effectiveRole,
              );
          ...
          console.log(
            "🔑 Pas de tokens stockés (flux connexion) → redirection vers signin",
          );
          toast.showToast({
            title: "Email vérifié",
    ...
    <View style={{ flex: 1, backgroundColor: colors.background, paddingTop: insets.top }}>
      ...
      <View className="flex-1 px-6 pt-6">
        ...
        <View className="items-center mb-6">
          ...
          <Text className="text-2xl font-jakarta-bold text-center" style={{ color: colors.textPrimary }}>
            Vérifiez votre email
          </Text>
          <Text className="text-base font-jakarta text-center mt-2 px-4" style={{ color: colors.textSecondary }}>
        ...
        <View className="items-center mt-8">
          <TouchableOpacity onPress={handleExit} activeOpacity={0.7}>
            <Text className="text-sm font-jakarta-semibold underline" style={{ color: colors.textSecondary }}>
